...
import { Sparkles, ShoppingBag, Trophy, Heart, Users, Music, DollarSign } from 'lucide-react';
...
const ToastItem: React.FC<{ toast: ToastMessage; onDismiss: (id: string) => void }> = ({ toast, onDismiss }) => {
  useEffect(() => {
    // Automatically dismiss each toast after 3.5 seconds
  ...
  return (
    <div className="pointer-events-auto animate-slideDown bg-slate-900/95 backdrop-blur-xl border border-pink-500/50 rounded-2xl p-4 shadow-2xl shadow-pink-950/50 text-white flex items-start gap-3.5 ring-2 ring-pink-500/30 transition-all duration-300">
